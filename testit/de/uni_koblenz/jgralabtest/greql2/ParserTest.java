...
public class ParserTest {
	...
	@Test
	public void testGreqlSyntaxGraphTestGraph() throws ParsingException {
	...
	public void testWhereWithSameScope() throws ParsingException {
		GreqlSyntaxGraph graph = parseQuery("from a,b:V with connected report a,b end where connected := a-->b");
	...
	public void testExistsOne() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("exists! x:list(1..5) @ x = 5");
	...
	public void testOrExpression() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("true or false");
	...
	public void testAndExpression() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("true and false");
		FunctionApplication funAp = graph.getFirstFunctionApplication();
		assertNotNull(funAp);
		IsFunctionIdOf isIdOf = funAp.getFirstIsFunctionIdOfIncidence();
		assertNotNull(isIdOf);
	...
	public void testXorExpression() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("true xor false");
		FunctionApplication funAp = graph.getFirstFunctionApplication();
		assertNotNull(funAp);
		IsFunctionIdOf isIdOf = funAp.getFirstIsFunctionIdOfIncidence();
		assertNotNull(isIdOf);
	...
	public void testEqualityExpression() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("true = false");
		FunctionApplication funAp = graph.getFirstFunctionApplication();
		assertNotNull(funAp);
		IsFunctionIdOf isIdOf = funAp.getFirstIsFunctionIdOfIncidence();
		assertNotNull(isIdOf);
	...
	public void testIdentifierWithDollar() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("from $i : V{} report $i end");
	...
	public void testIdentifierWithDollar2() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("using $: from i:$ report i end");
		Variable v = graph.getFirstVariable();
		assertNotNull(v);
	...
	public void testTypeId() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("V{Part!}");
	...
	public void testLessThanExpression() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("5 < 6");
		FunctionApplication funAp = graph.getFirstFunctionApplication();
		assertNotNull(funAp);
		IsFunctionIdOf isIdOf = funAp.getFirstIsFunctionIdOfIncidence();
		assertNotNull(isIdOf);
	...
	public void testBooleanLiteral() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("true");
	...
	public void testIntegerLiteral() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("5");
	...
	public void testHexLiteral() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("0x5");
		IntLiteral lit = graph.getFirstIntLiteral();
		assertNotNull(lit);
		assertEquals(5, lit.get_intValue());
	...
	public void testOctLiteral() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("05");
		IntLiteral lit = graph.getFirstIntLiteral();
		assertNotNull(lit);
		assertEquals(5, lit.get_intValue());
	...
	public void assertDoubleLiteralEquals(String literal, double expectedValue) {
		GreqlSyntaxGraph graph = parseQuery(literal);
	...
	public void testUnaryExpressionNot() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("not true");
		FunctionApplication funAp = graph.getFirstFunctionApplication();
		assertNotNull(funAp);
		IsFunctionIdOf isIdOf = funAp.getFirstIsFunctionIdOfIncidence();
		assertNotNull(isIdOf);
	...
	public void testListConstruction() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("list(10,11,12,13)");
	...
	public void testGreTLQuery() throws Exception {
		...
		GreqlSyntaxGraph graph = parseQuery(query);
		assertNotNull(graph);
	...
	public void testRole() throws Exception {
		...
		GreqlSyntaxGraph graph = parseQuery(queryString);
		assertNotNull(graph);
	...
	public void testListRangeConstruction() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("list(10..13)");
	...
	public void testSetConstruction() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("set(10,11,12,13)");
	...
	public void testRecordConstruction() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("rec(a:5,b:\"Yes\")");
	...
	public void testForallExpression() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("forall v:set(1,2,3) @ v < 7");
	...
	public void testExistsExpression() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("exists v:set(1,2,3) @ v < 7");
		Variable var = graph.getFirstVariable();
		assertNotNull(var);
		assertEquals("v", var.get_name());
		QuantifiedExpression expr = graph.getFirstQuantifiedExpression();
	...
	// ManualGreqlSyntaxGraphParser parser = getParser("exists!");
	// parser.initialize();
	// try {
	...
	public void testVariableList() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("from a,b,c,d:V report a end");
		Variable var = graph.getFirstVariable();
		assertNotNull(var);
	...
	public void testSimpleQueryWithConstraint() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("from var: V with isPrime(var) report var end");
		Variable var = graph.getFirstVariable();
		assertNotNull(var);
	...
	public void testSimpleQueryWithMultipleDeclarations() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("from var: V{Definition}, def: V{WhereExpression} report var end");
		Variable var = graph.getFirstVariable();
		assertNotNull(var);
		assertEquals("var", var.get_name());
		var = var.getNextVariable();
	...
	public void testSimpleQuery1() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("from var: V{Definition}, def: V{WhereExpression} with var -->{IsDefinitionOf} | -->{IsVarOf}  def report var end");
		ListComprehension comp = graph.getFirstListComprehension();
		assertNotNull(comp);
		IsCompDeclOf declEdge = comp.getFirstIsCompDeclOfIncidence();
		assertNotNull(declEdge);
	...
	public void testSimpleQuery2() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("using FOO: from i: toSet(FOO) report i end");
	...
	public void testUsing() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("using A: from b:A report b end");
		Greql2Expression root = graph.getFirstGreql2Expression();
		assertNotNull(root);
		IsBoundVarOf boundVarEdge = root.getFirstIsBoundVarOfIncidence();
		assertNotNull(boundVarEdge);
	...
	public void testLetExpression2() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("let x:= list (5..13) in count(x)");
		assertNotNull(graph);
	}

	@Test
	public void testFRQuery() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("from v:V report v end");
		Variable var = graph.getFirstVariable();
		assertNotNull(var);
		assertEquals("v", var.get_name());
	...
	public void testFunctionApplication() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("from v:V report degree(v) end");
		Variable var = graph.getFirstVariable();
		assertNotNull(var);
		assertEquals("v", var.get_name());
		VertexSetExpression expr = graph.getFirstVertexSetExpression();
	...
	public void testConditionalExpression() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("1=2 ? true : false");
	...
	public void testConditionalExpression2() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("1=1?1:2");
		Greql2Expression root = graph.getFirstGreql2Expression();
		assertNotNull(root);
	...
	public void testVertexSetExpression() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("V{FirstType, SecondType, ^ThirdType}");
	...
	public void testEdgeSetExpression() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("E{^FirstType, ^SecondType, ThirdType}");
	...
	public void testSubgraphExpression() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("(kappa(1) : using v: v +>)");
	...
	public void testAlternativePathDescriptionWithTypes() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("using v: v -->{AType} | <--{AnotherType}");
		Variable var = graph.getFirstVariable();
		assertNotNull(var);
		assertEquals("v", var.get_name());
	...
	public void testPathDescriptionWithParantheses1() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("(--> | <--)");
		AlternativePathDescription apd = graph
				.getFirstAlternativePathDescription();
		assertNotNull(apd);
		IsAlternativePathOf edge = apd
	...
	public void testTypedPathDescription() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("using v: v -->{AType} ");
		Variable var = graph.getFirstVariable();
		assertNotNull(var);
		assertEquals("v", var.get_name());
		ForwardVertexSet vset = graph.getFirstForwardVertexSet();
	...
	public void testIntermediateVertexPathDescription() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("using v: v --> v <-- ");
		ForwardVertexSet vset = graph.getFirstForwardVertexSet();
		assertNotNull(vset);
	...
	public void testStartRestrictedPathDescriptionWithExpression()
			throws Exception {
		GreqlSyntaxGraph graph = parseQuery("using v: v {@v.a=3} & --> ");
	...
	public void testStartRestrictedPathDescriptionWithType() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("using v: v {MyType} & --> ");
	...
	public void testGoalRestrictedPathDescription() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("using v: v --> & {@false} ");
		ForwardVertexSet vset = graph.getFirstForwardVertexSet();
		assertNotNull(vset);
	...
	public void testPathExistence() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("using v,w: v --> w ");
	...
	public void testEdgePathDescription() throws Exception {
		GreqlSyntaxGraph graph = parseQuery("using e,v : v --e-> ");
		ForwardVertexSet vset = graph.getFirstForwardVertexSet();
		assertNotNull(vset);
	...
	public void testStringWithoutEscapes() {
		GreqlSyntaxGraph graph = parseQuery("\"my simple string\"");
		assertNotNull(graph);
