...
public class TableComprehensionEvaluator extends VertexEvaluator {
	...
	public Object evaluate() {
		...
		IsTableHeaderOf_isTableHeaderOf_omega tHeader = vertex
				.getFirst_isTableHeaderOf_omega();
		if (tHeader != null) {
