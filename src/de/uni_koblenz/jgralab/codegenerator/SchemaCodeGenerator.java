...
public class SchemaCodeGenerator extends CodeGenerator {
	...
	private CodeBlock createGraphFactoryMethod() {
		...
		CodeSnippet code = new CodeSnippet(
				...
				" * @param eMax initial edge count",
				" */",
				"public #gcName# create#gcCamelName#_Diskv2BasedStorage(String uniqueGraphId, int vMax, int eMax) {",
				"\tString hostname = null;",
				"\ttry {",
				"\t\thostname = InetAddress.getLocalHost().getHostAddress();",
				"\t} catch (UnknownHostException ex) {",
				"\t\tthrow new RuntimeException(ex);",
				"\t}",
				"\tlong subgraphId = #jgDiskv2ImplPackage#.GraphDatabaseElementaryMethods.GLOBAL_GRAPH_ID;",
				"\t#jgDiskv2ImplPackage#.GraphDatabaseBaseImpl graphDb = new #jgDiskv2ImplPackage#.CompleteGraphDatabaseImpl(this, uniqueGraphId, hostname);",
				"\treturn (#gcCamelName#) graphFactory.createGraph_Diskv2BasedStorage(#gcCamelName#.class, uniqueGraphId, subgraphId, graphDb, graphDb);",
				"}",
				"",
				"/**",
				" * Creates a new #gcName# graph using version 2 of disk based storage. To be called only by the graph database class!",
				" *",
				"*/",
				"public #gcName# create#gcCamelName#_Diskv2BasedStorage(String uniqueGraphId, long subgraphId, #jgDiskv2ImplPackage#.GraphDatabaseBaseImpl graphDb) {",
				"\treturn (#gcCamelName#) graphFactory.createGraph_Diskv2BasedStorage(#gcCamelName#.class, uniqueGraphId, subgraphId, graphDb, graphDb);",
				"}",
				"",
				"/**",
				" * Creates a new #gcName# graph using version 2 of disk based storage. This method should be called by a user  ",
				" * to create a new #gcName#-graph instance. The local hostname is detected automatically",
				" *",
				"*/",
				"public #gcName# create#gcCamelName#_Diskv2BasedStorage() {",
				"\tString uniqueGraphId = GraphFactoryImpl.generateUniqueGraphId();",
				"\tString hostname = null;",
				"\ttry {",
				"\t\thostname = InetAddress.getLocalHost().getHostAddress();",
				...
				" *",
				"*/",
				"public #gcName# create#gcCamelName#_Diskv2BasedStorage(String localHostAddress) {",
				"\tString uniqueGraphId = GraphFactoryImpl.generateUniqueGraphId();",
				"\tlong subgraphId = #jgDiskv2ImplPackage#.GraphDatabaseElementaryMethods.GLOBAL_GRAPH_ID;",
				"\t#jgDiskv2ImplPackage#.GraphDatabaseBaseImpl graphDb = new #jgDiskv2ImplPackage#.CompleteGraphDatabaseImpl(this, uniqueGraphId, localHostAddress);",
				"\treturn (#gcCamelName#) graphFactory.createGraph_Diskv2BasedStorage(#gcCamelName#.class, uniqueGraphId, subgraphId, graphDb, graphDb);",
				"}",
				"",
