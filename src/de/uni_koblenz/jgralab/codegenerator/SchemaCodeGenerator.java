...
public class SchemaCodeGenerator extends CodeGenerator {
	...
	private CodeBlock createGraphFactoryMethod() {
		...
		CodeSnippet code = new CodeSnippet(
				...
				"\treturn (#gcCamelName#) graphFactory.createGrapInMemoryStorageh(#gcCamelName#.class, id, vMax, eMax);",
				"}",
				"",
				"/**",
				...
				" * @param eMax initial edge count",
				"*/",
				"public #gcName# create#gcCamelName#OnDisk(int vMax, int eMax) {",
				"\treturn (#gcCamelName#) graphFactory.createGraphDiskBasedStorage(#gcCamelName#.class, GraphFactoryImpl.generateUniqueGraphId(), vMax, eMax);",
				"}",
				"",
				"/**",
				...
				" * @param eMax initial edge count",
				" */",
				"public #gcName# create#gcCamelName#OnDisk(String id, int vMax, int eMax) {",
				...
				"\treturn (#gcCamelName#) graphFactory.createGraphDiskBasedStorage(#gcCamelName#.class, GraphFactoryImpl.generateUniqueGraphId());",
				"}",
				"",
				"/**",
				" * Creates a new #gcName# graph with the ID <code>id</code>.",
				...
				" * @param id the id name of the new graph",
				" */",
				"public #gcName# create#gcCamelName#OnDisk(String id) {",
				...
				"/**",
				" * Loads a #gcName# graph from the file <code>filename</code> using the in-memory storage.",
				" *",
				" * @param filename the name of the file",
				" * @return the loaded #gcName#",
				" * @throws GraphIOException if the graph cannot be loaded",
				" */",
				"public #gcName# load#gcCamelName#InMem(String filename) throws GraphIOException {",
				"\treturn load#gcCamelName#InMem(filename, null);",
				"}",
				"",
				"/**",
				...
				" * @throws GraphIOException if the graph cannot be loaded",
				" */",
				"public #gcName# load#gcCamelName#InMem(String filename, ProgressFunction pf) throws GraphIOException {",
				"\tGraph graph = GraphIO.loadGraphFromFileInMemoryStorage(filename, this, pf);\n"
				...
				"",
				"/**",
				" * Loads a #gcName# graph from the file <code>filename</code> using the disk-based storage.",
				" *",
				" * @param filename the name of the file",
				" * @return the loaded #gcName#",
				" * @throws GraphIOException if the graph cannot be loaded",
				" */",
				"public #gcName# load#gcCamelName#OnDisk(String filename) throws GraphIOException {",
				"\treturn load#gcCamelName#OnDisk(filename, null);",
				"}",
				"",
				"/**",
				" * Loads a #gcName# graph from the file <code>filename</code> using the disk-based storage.",
				...
				" * @throws GraphIOException if the graph cannot be loaded",
				" */",
				"public #gcName# load#gcCamelName#OnDisk(String filename, ProgressFunction pf) throws GraphIOException {",
				"\tGraph graph = GraphIO.loadGraphFromFileDiskBasedStorage(filename, this, pf);\n"
						+ "\tif (!(graph instanceof #gcName#)) {\n"
						+ "\t\tthrow new GraphIOException(\"Graph in file '\" + filename + \"' is not an instance of GraphClass #gcName#\");\n"
						+ "\t}" + "\treturn (#gcName#) graph;\n",
				"}",
