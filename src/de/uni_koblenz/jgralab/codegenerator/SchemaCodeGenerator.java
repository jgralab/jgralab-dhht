...
public class SchemaCodeGenerator extends CodeGenerator {
	...
	private CodeBlock createGraphFactoryMethod() {
		...
		CodeSnippet code = new CodeSnippet(
				...
				" *",
				"*/",
				"public #gcName# create#gcCamelName#_DiskBasedStorage(String uniqueGraphId, long subgraphId, GraphDatabaseBaseImpl graphDb) {",
				"\treturn (#gcCamelName#) graphFactory.createGraph_DiskBasedStorage(#gcCamelName#.class, uniqueGraphId, subgraphId, graphDb, graphDb);",
				"}",
				"",
				"/**",
				...
				" *",
				"*/",
				"public #gcName# create#gcCamelName#_DistributedStorage(String uniqueGraphId, long subgraphId, GraphDatabaseBaseImpl graphDb) {",
				"\treturn (#gcCamelName#) graphFactory.createGraph_DistributedStorage(#gcCamelName#.class, uniqueGraphId, subgraphId, graphDb, graphDb);",
				"}",
				"",
				"/**",
