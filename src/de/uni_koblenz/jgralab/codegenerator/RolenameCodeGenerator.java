	...
	private CodeBlock createRemoveIncidenceSnippet(IncidenceClass incClass, boolean createClass) {
		...
		if (!createClass) {
			code.add("/**",
					 ...
					 " */",
					 "public boolean remove_#rolename#(#definingIncidentElementClassName# element) throws RemoteException;");
		} else {
			code.add("@Override",
					 "public boolean remove_#rolename#(#definingIncidentElementClassName# element) throws RemoteException {",
	...
	private CodeBlock createAddIncidenceSnippet(IncidenceClass incClass, IncidenceClass allowedIncClass, boolean createClass) {
		...
		if (!createClass) {
			code.add("/**",
					 ...
					 " * the given one.", " */",
					 "public void add_#rolename#(#definingIncidentElementClassName# element) throws RemoteException;");
		} else {
			code.add("@Override",
					 "public void add_#rolename#(#definingIncidentElementClassName# element) throws RemoteException {",
