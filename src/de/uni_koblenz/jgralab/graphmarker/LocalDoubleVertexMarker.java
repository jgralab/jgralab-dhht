...
public class LocalDoubleVertexMarker extends LocalDoubleGraphMarker<Vertex> {

	public LocalDoubleVertexMarker(Graph graph) {
			...
			public Iterator<Vertex> iterator() {
				return new LocalArrayGraphMarkerIterator<Vertex>(version) {
					...
					public Vertex next() {
						...
						if (version != LocalDoubleVertexMarker.this.version) {
